        ...
        <div class="panel panel-dark panel-colorful">
          <div class="panel-body text-center">
            <router-link to="/contact" class="text-white">
              ...
              <hr />
              <p class="h2 text-thin">{{ this.numberOfContacts }}</p>
              <small
                ><span class="text-semibold"
                  ><i class="fa fa-unlock-alt fa-fw"></i>
                  {{ this.numberOfContacts }}</span
                >
                Comments</small
              >
            </router-link>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
       ...
       <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="panel panel-info panel-colorful">
          <div class="panel-body text-center">
            <router-link to="/application-list" class="text-white">
              <p class="text-uppercase mar-btm text-sm">APPLICATIONS</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="90"
                height="90"
            ...
            <router-link to="application-list" class="text-white">
              <p class="h2 text-thin">{{ this.numberOfApplications }}</p>
              <small
                ><span class="text-semibold"
                  ><i class="fa fa-unlock-alt fa-fw"></i>
                  {{ this.numberOfApplications }}</span
                >
                Services</small
              >
            </router-link>
